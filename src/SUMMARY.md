...
- [Developing Pups](./pup_development.md)
  ...
  - [Pup Manifest](./pup_dev_manifest.md)
  - [pup.nix](./pup_dev_nix.md)
  - [Pup Dependencies](./pup_dev_deps.md)
  - [Pup to Pup Communication](./pup_dev_comms.md)
  - [Pup Metrics](./pup_dev_metrics.md)
